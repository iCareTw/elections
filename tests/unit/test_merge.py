...
EXISTING = [
    {
        'name': '柯文哲', 'id': 'id_柯文哲_1959', 'birthyear': 1959, 'elections': [
            {'year': 2014, 'type': '縣市首長', 'region': '臺北市', 'party': '無黨籍', 'elected': 1},
        ]
    },
    {
        'name': '許淑華', 'id': 'id_許淑華_1973', 'birthyear': 1973, 'elections': [
            {'year': 2016, 'type': '縣市議員', 'region': '臺北市', 'party': '民主進步黨', 'elected': 1}
        ]
    },
    {
        'name': '許淑華', 'id': 'id_許淑華_1975', 'birthyear': 1975, 'elections': [
...
def test_new_person():
    records = [{'name': '吳欣盈', 'birthyear': 1978, 'year': 2024,
...
def test_existing_person_same_party():
    ...
    records = [{'name': '柯文哲', 'birthyear': 1959, 'year': 2018,
...
def test_conflict_party_switch():
    ...
    records = [{'name': '柯文哲', 'birthyear': 1959, 'year': 2024,
                'type': '國家元首_總統', 'region': '全國', 'party': '台灣民眾黨', 'elected': 0}]
    result = classify_records(records, EXISTING)
...
def test_conflict_year_mismatch():
    ...
    records = [{'name': '許淑華', 'birthyear': 1971, 'year': 2024,
...
def test_duplicate_election_skipped():
    records = [{'name': '柯文哲', 'birthyear': 1959, 'year': 2014,
                'type': '縣市首長', 'region': '臺北市', 'party': '無黨籍', 'elected': 1}]
    result = classify_records(records, EXISTING)
